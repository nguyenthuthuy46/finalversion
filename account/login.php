                    ...
                    <div class="col-md-7">
                        ...
                        <form class="form-vertical" action="" method="post">
                            ...
                            <div class="form-group first"
                                 style="border: 1px solid  #868080 !important;height: 50px !important; border-radius: 8px;">
                            ...
                            <div class="social-login" style="margin-top: 10%;">
                                <span class="d-flex justify-content-center align-items-center">Dont have a account? <a
                                            href="register.php" class="ml-2 mt-2"
                                            style="color: #00bfff"> Sign Up</a></span>
                            </div>
                        </form>
                    </div>
                </div>
...
if (isset($_POST["login"])) {
    ...
    ?>
        <script type="text/javascript">
            window.location = "/user/admin/manage_users.php";
        </script>
        <?php
    }
}
